        ...
        AdapterCallback<T> // Adapter更新接口
{
     ...
     * @param listener 监听器
     */
    public BaseRecyclerAdapter(List<T> dataList, AdapterListener<T> listener) {
        this.mDataList = dataList;
        this.mListener = listener;
    }

    public BaseRecyclerAdapter(AdapterListener<T> listener) {
    ...
    public static abstract class BaseViewHolder<T> extends RecyclerView.ViewHolder {
        ...
        public void setColor(@IdRes int itemId, int color) {
            ((TextView) getView(itemId)).setTextColor(color);
        }
